  ...
  .catch((error) => {
    ...
    return (
       ...
       <div className="text-center" style={{marginTop:"250px"}}>
                    <h1 className="text-primary fs-1 fw-bold">Learn more</h1>
                    <h3 className="text-danger">Create an  <span className="fs-1 text danger"> Account</span></h3>
...
{/*--------------------------- submit button add ---------------------------------------*/}
  ...
  {/*------------------------------ conditional signin signOut button ----------------------------*/}
       {!user.name?
         <div className="me-5">
            <button onClick={ handleGoogleSignin} type="button" className="btn btn-danger my-3"> Sign in with Google</button>
              <br />
              <button onClick={ handleGitSignin} type="button" className="btn btn-danger">Sign in with Git</button>
              <button onClick={ handleFacebookSignin} type="button" className="btn btn-danger m-5">Sign in with Facebook</button>
       </div>:
