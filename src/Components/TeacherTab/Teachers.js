...
console.log("here")
    ...
    return (
        <div className="bg-info" style={{marginTop:"130px"}}>
           ...
           <NavLink to="/" style={{textDecoration:"none"}} ><h1 className="border p-4 text-dark fw-bolder mt-5 p-5 ">Courses<FontAwesomeIcon icon ={faArrowAltCircleRight}></FontAwesomeIcon>
            </h1>
            </NavLink>
