    ...
    return (
        <div className="bg-info" style={{marginTop:"130px"}}>
            ...
            <div>
                ...
                <h1 className="border p-4 text-dark fw-bolder mt-5 p-5 ">Mathematics <FontAwesomeIcon icon ={faArrowAltCircleRight}></FontAwesomeIcon></h1>
                {/* </Link> */}
                <div>
            ...
            <div>
                <h1 className="border p-4 bg-Secondary fw-bolder mt-5 p-5">Science <FontAwesomeIcon icon ={faArrowAltCircleRight}></FontAwesomeIcon>
                </h1>
                <div>
                    <div class="row row-cols-1 row-cols-md-4 g-4">{
