...
<nav className="navbar navbar-expand-lg navbar-dark primary fixed-top ">
  <div className="container-fluid">
    <a className="navbar-brand ms-5" style={{fontSize:"25px"}} href="/shop"><span className="focusName text-danger fw-bolder">Edu</span>Noggle <FontAwesomeIcon className="ms-2" style={{fontSize:"40px"}} icon={faBookOpen}></FontAwesomeIcon>
</a>
    ...
    <div className="collapse navbar-collapse" id="navbarSupportedContent">
      <ul className="navbar-nav ms-auto mb-2 mb-lg-0">
        ...
        <li className="nav-item">
          ...
          <button  type="button"   className="btn btn-success me-2"><FontAwesomeIcon className="text-dark me-2" icon={faShoppingCart}></FontAwesomeIcon> Your Cart </button>
